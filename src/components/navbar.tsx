    ...
    <header className="sticky top-0 z-50 w-full bg-white">
      <nav className="w-full h-30" aria-label="Primary">
        <div className="w-full
          grid grid-cols-[max-content_minmax(0,1fr)_max-content_max-content_max-content] items-center
          gap-x-8 lg:gap-x-10 px-6 sm:px-8 lg:px-12 py-5">
            
          {/* Left: brand */}
          <div className="flex items-center justify-self-center ml-2 sm:ml-4">
          ...
          <Link
            ...
            className={`justify-self-center inline-flex h-12 w-22 flex-col items-center justify-center text-center leading-none transition-colors ${getActionClasses("favorite")}`}
          >
          ...
          <Link
            ...
            className={`justify-self-center inline-flex h-12 w-22 flex-col items-center leading-none transition-colors ${getActionClasses("help")}`}
          >
            <span className="material-symbols-outlined text-2xl" aria-hidden>
              help
            </span>
          ...
          {/* Profile / Login */}
          {user ? (
            <div className="relative justify-self-center" ref={menuRef}>
              <button
                type="button"
                onClick={handleProfileClick}
                className="inline-flex h-12 w-22 flex-col items-center leading-none text-[#016B71] hover:text-[#01585C] focus:outline-none"
                aria-haspopup="menu"
              ...
              >
                ...
                <span className="text-xs mt-1 truncate max-w-24" title={displayName}>
                  {displayName}
                </span>
              </button>
            ...
            <Link
              to="/login"
              className="justify-self-center rounded-full bg-[#016B71] px-5 py-2 font-bold text-white shadow-[0_6px_0_rgba(0,0,0,.18)] transition hover:bg-[#01585C] active:translate-y-px"
            >
              Log In
            </Link>
          )}
