...
import Hero from "../../../assets/bgofsignup.jpg"; 
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <section
        ...
        aria-label="Scenic mountains background"
      >
        {/* Background image layer */}
        <img src={Hero} alt="" className="absolute inset-0 h-full w-full object-cover -z-10" />

        {/* Tint overlay */}
        <div className="absolute inset-0 bg-black/10 z-0" />

        {/* Foreground content */}
        <div className="relative z-10 mx-auto max-w-7xl px-4 py-10 sm:py-16">
            ...
            <form onSubmit={onSubmit} className="px-6 pb-6 space-y-4">
              ...
              >
                ...
                <svg width="20" height="20" viewBox="0 0 48 48" aria-hidden>
                  <path fill="#FFC107" d="M43.6 20.5H42V20H24v8h11.3C33.6 31.9 29.2 35 24 35c-6.6 0-12-5.4-12-12S17.4 11 24 11c3 0 5.7 1.1 7.8 3l5.7-5.7C34 5.4 29.3 3.5 24 3.5 12 3.5 2.5 13 2.5 25S12 46.5 24 46.5 45.5 37 45.5 25c0-1.5-.2-3-.5-4.5z"/>
        ...
        <footer className="absolute bottom-0 left-0 right-0">
          <div className="mx-auto max-w-7xl px-4 py-4">
            <div className="w-full rounded-t-xl bg-[#CDE9EB] px-4 py-3 text-center text-xs text-slate-800">
