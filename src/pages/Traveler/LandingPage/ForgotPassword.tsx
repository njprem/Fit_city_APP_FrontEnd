...
// type ApiResp = { ok: boolean; message?: string }; // ปรับตามสัญญา API ของคุณ
...
//       setSubmitting(true);
//       setError("");
//       const res = await apiResetPassword({ email, otp: otp.trim(), newPassword: pwd });
//       if (res.ok) {
...
//         setPwd2("");
//       } else {
//         setError(res.message || "Unable to reset password. Please check your OTP and try again.");
//       }
//     } catch {
